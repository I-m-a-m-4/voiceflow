...
export const PRESET_BANNERS = [
  {
    ...
    dataUrl: `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="600" height="320" viewBox="0 0 600 320">
      ...
      <text x="40" y="80" fill="%2338bdf8" font-family="system-ui, sans-serif" font-weight="900" font-size="20" letter-spacing="2">VOICEFLOW DESKTOP VIP</text>
  ...
  },
  {
    ...
    dataUrl: `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="600" height="320" viewBox="0 0 600 320">
      ...
      <text x="40" y="80" fill="%23d8b4fe" font-family="system-ui, sans-serif" font-weight="900" font-size="20" letter-spacing="2">VOICEFLOW ZEN-AI PRO</text>
...
export const DEFAULT_PROMO_CONFIG: PromoToastConfig = {
  ...
  title: 'Upgrade to Voiceflow Pro',
