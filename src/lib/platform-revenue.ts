/**
 * Voiceflow's own money, in one place.
 *
 * The platform carries two figures that both get called revenue, and only one of
 * them is Voiceflow's:
 *
 * - **GMV** — the sum of tenant receipts: what the shops using Voiceflow sold to
 *   *their* customers. Real money, but not Voiceflow's. It belongs nowhere near
 *   Voiceflow's own revenue, run rate or valuation.
 * - **`purchases`** — payments made *to* Voiceflow. That is the company's revenue,
 ...
 * naira can perfectly well have paid Voiceflow in dollars through Dodo.
 *
