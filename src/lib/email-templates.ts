/**
 * Voiceflow campaign email design system.
 *
 ...
 *   Outlook dark mode invert light backgrounds and drag Voiceflow's orange toward
...
const BASE_URL = (process.env.NEXT_PUBLIC_BASE_URL || 'https://voiceflow.space').replace(/\/+$/, '');

/** The signature every campaign goes out under. */
export const CAMPAIGN_FROM = 'Imam Shaffy <hello@voiceflow.space>';
export const CAMPAIGN_REPLY_TO = 'hello@voiceflow.space';
...
export function mergeTokensFor(profile: BehaviorProfile): MergeTokens {
  ...
  return {
    ...
    topFeature: top?.label ?? 'Voiceflow',
    topFeatureWhere: top?.inSentence ?? 'in Voiceflow',
 ...
 * better against Voiceflow's orange than a blue-grey would) and orange is reserved
 ...
 * Type stacks.
 *
 * Bricolage Grotesque is the face the Voiceflow logo is set in and DM Sans is the
...
export const SOCIAL_LINKS = [
  { key: 'instagram', label: 'Instagram', href: 'https://www.instagram.com/voiceflow_pos/' },
  { key: 'x', label: 'X', href: 'https://x.com/voiceflow_retail' },
  { key: 'tiktok', label: 'TikTok', href: 'https://www.tiktok.com/@voiceflow_retail' },
  { key: 'youtube', label: 'YouTube', href: 'https://www.youtube.com/@VoiceflowPos' },
    ...
    <tr>
      <td class="z-pad" align="center" style="padding:32px 32px 14px;text-align:center;">
        <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" style="margin:0 auto;">
          <tr>
            <td align="center">
              <img src="https://i.ibb.co/tMp65gRP/5c1014423d18.png" alt="Voiceflow" width="68" height="68"
    ...
    <tr>
      <td bgcolor="${BRAND.panel}" style="background-color:${BRAND.panel};border-top:1px solid ${BRAND.line};padding:22px 32px 24px;text-align:center;">
        ...
        <p style="margin:0 0 6px;font-family:${FONT_BODY};font-size:12px;line-height:1.5;color:${BRAND.muted};">
          <a href="${BASE_URL}" style="color:${BRAND.orangeDeep};font-weight:600;text-decoration:none;">voiceflow.space</a>
          &nbsp;&middot;&nbsp;
        ...
        <p style="margin:0;font-family:${FONT_BODY};font-size:11px;color:${BRAND.faint};">
          &copy; ${year} Voiceflow POS &amp; Inventory. All rights reserved.
        </p>
      </td>
    </tr>
...
export const CAMPAIGN_DRAFTS: Record<BehaviorSegment, EmailDraft> = {
  active: {
    subject: 'Voiceflow Updates for {{businessName}}',
    preheader: 'Check out the latest features in Voiceflow.',
    eyebrow: 'Product Update',
    heading: 'New Features Live',
    heroImage: '/emails/3d-folder.jpg',
    body: 'Thank you for actively using Voiceflow.',
    callout: '',
    ctaLabel: 'Go to Dashboard',
    ctaPath: '/dashboard',
    signOffName: 'Imam Shaffy',
    signOffTitle: 'Founder, Voiceflow',
  },
  churn_risk: {
    subject: 'Need any help with {{businessName}}?',
    preheader: 'We are here to support your team.',
    eyebrow: 'Checking in',
    heading: 'Can we help?',
    heroImage: '/emails/3d-folder.jpg',
    body: 'We noticed you have not logged in recently.',
    callout: '',
    ctaLabel: 'Open Voiceflow',
    ctaPath: '/dashboard',
    signOffName: 'Imam Shaffy',
    signOffTitle: 'Founder, Voiceflow',
  },
  power_user: {
    subject: 'VIP Perks for {{businessName}}',
    preheader: 'Special benefits for active power users.',
    eyebrow: 'Power User',
    heading: 'VIP Status Unlocked',
    heroImage: '/emails/3d-gift.jpg',
    body: 'You are one of our power users.',
    callout: '',
    ctaLabel: 'View Perks',
    ctaPath: '/dashboard',
    signOffName: 'Imam Shaffy',
  ...
  dormant: {
    ...
    body: 'Your data is safe and waiting.',
    callout: '',
  ...
  never_activated: {
    ...
    heroImage: '/emails/3d-folder.jpg',
    body: `I am Imam, the founder of Voiceflow. I noticed you created an account for **{{businessName}}** but have not had a chance to get into it yet.

Getting your products into a new system can feel like a chore, but in Voiceflow it takes seconds: snap a barcode, add an item name, and you are ready to sell.
...
If now is not the right time, that is completely fine. Reply anytime and I will help you out.`,
  ...
  onboarding_stalled: {
    ...
    heroImage: '/emails/3d-folder.jpg',
    body: `You have your catalog in Voiceflow for **{{businessName}}**, which is awesome. The only missing piece is ringing up your very first sale.
...
If anything is blocking you — a barcode scanner, receipt printer, or custom pricing — hit reply and let me know.`,
  ...
  invested_then_left: {
    ...
    heroImage: '/emails/3d-milestone.jpg',
    body: `You did the part almost nobody finishes: you set up **{{businessName}}** in Voiceflow, imported your inventory, and spent real time in it.
...
If a bug or missing feature slowed you down, tell me. I read and reply to every message personally.`,
  ...
  champion: {
    ...
    heroImage: '/emails/3d-gift.jpg',
    body: `You are one of the rare merchants running their daily business operations entirely on Voiceflow.
...
It is already active in your account — no setup or extra fees required.`,
    callout:
      'Your store activity: {{topFeatureShare}} of your activity in Voiceflow is {{topFeatureWhere}}, out of {{pageViews}} total views.',
  ...
  casual_active: {
    ...
    preheader: 'Short list. All already unlocked in your Voiceflow account.',
    eyebrow: 'Power tips',
    heading: 'Look how far you’ve come.',
    heroImage: '/emails/3d-milestone.jpg',
    body: `You have been checking into Voiceflow regularly. Here are three quick power features that store owners love most:
...
**Low-Stock Alerts:** Get notified before popular items run out of stock.`,
    callout: 'You have put {{usage}} into Voiceflow so far across {{pageViews}} page views.',
    ctaLabel: 'Open Voiceflow dashboard',
    ctaPath: '/dashboard',
    signOffName: 'Imam Shaffy',
    signOffTitle: 'Founder, Voiceflow',
  },
  ...
  slipping: {
    ...
    heading: 'A thank-you, just for you.',
    heroImage: '/emails/3d-gift.jpg',
    body: `We noticed you have not visited Voiceflow in {{daysSince}} days. Running a store is busy, and we want to make sure you have everything you need to succeed.
...
Come see what is new in version 3.3.2!`,
    callout:
      'Your store history: {{usage}} logged in Voiceflow across {{pageViews}} page views.',
