...
const INSTALL_ID_KEY = 'voiceflow_install_id';
const SENT_STAGES_KEY = 'voiceflow_launch_sent';
const QUEUE_KEY = 'voiceflow_launch_queue';
const SESSION_OPENED_KEY = 'voiceflow_launch_session_open';
...
function getCanvasFingerprint(): string {
  try {
    ...
    ctx.fillStyle = '#069';
    ctx.fillText('VoiceflowTelemetry', 2, 15);
    ctx.fillStyle = 'rgba(102, 204, 0, 0.7)';
    ctx.fillText('VoiceflowTelemetry', 4, 17);
