/**
 * A ready-made recording for every Voiceflow page you can land on cold.
 *
...
const HOUSE_END: [string, string, string] = ['Voiceflow', 'Retail, handled.', 'Start free'];
...
export const PRESETS: Preset[] = [
  // ------------------------------------------------------------------- Sell
  {
    ...
    end: ['Sell anywhere. Even offline.', 'Voiceflow POS', 'Start free'],
    steps: [
  ...
  // ------------------------------------------------------------------ Stock
  {
    ...
    end: ['Counts you can trust, on every device.', 'Voiceflow Inventory', 'Start free'],
    steps: [
