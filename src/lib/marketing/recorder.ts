...
export function blankRecipe(route = '/dashboard'): Recipe {
  return {
    title: 'New recording',
    route,
    open: { title: 'Voiceflow', subtitle: 'Retail, handled.', ms: 2200 },
    end: { title: 'Voiceflow', subtitle: 'Retail, handled.', cta: 'Start free', ms: 2600 },
    steps: [
...
export const FLOW_CARD_DEFAULTS: Record<FlowId, { open: TitleCard; end: TitleCard }> = {
  pos: {
    ...
    end: { title: 'Sell anywhere. Even offline.', subtitle: 'Voiceflow POS', cta: 'Start free', ms: 2600 },
  },
  inventory: {
    open: { title: 'Know what you have.', subtitle: 'Down to the last unit.', ms: 1900 },
    end: { title: 'Counts you can trust, on every device.', subtitle: 'Voiceflow Inventory', cta: 'Start free', ms: 2600 },
  },
  zen: {
