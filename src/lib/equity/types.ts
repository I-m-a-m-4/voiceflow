 ...
 *
 * Voiceflow's own equity — who owns what share of the company — not tenant data.
 *
...
export interface RevenueInputs {
  /** Every subscription payment Voiceflow has ever collected, in the settings currency. */
