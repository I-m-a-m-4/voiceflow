...
/**
 * Voiceflow's own trading figures, for the Valuation tab.
 *
 ...
 *
 * The definitions themselves — which collection is Voiceflow's revenue, how a
...
export interface PurchaseLike {
   ...
   * figures below: a pack sale is money Voiceflow received, and those are revenue
