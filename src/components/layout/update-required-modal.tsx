      ...
      >
        ...
        <div className="text-sm text-muted-foreground leading-relaxed">
          {settings?.isHardForce 
            ? "Please update to the latest version of Voiceflow. This version has expired and you can no longer use it."
            : "A new version of Voiceflow is available. Please update to get the latest features and improvements."}
        </div>
