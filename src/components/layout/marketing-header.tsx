        ...
        <div className="w-full h-20 bg-white">
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center justify-center" prefetch={false} onClick={() => setIsMobileMenuOpen(false)}>
              <img src={AppConfig.logoUrl} alt="Voiceflow Logo" className="h-16 w-auto" />
            </Link>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="hidden sm:flex items-center gap-4">
              {mounted && user ? (
                <>
                  <Link href="/dashboard" className="hover:bg-[#0f172a] transition-colors text-sm font-medium text-white tracking-tight font-dm-sans bg-[#1e293b] rounded-md pt-2.5 pr-5 pb-2.5 pl-5 shadow-sm">{t('nav.dashboard')}</Link>
      ...
      <div className={cn(
        ...
        <div className="container mx-auto px-6 py-8">
          ...
          <div className="mt-8 flex flex-col gap-4">
            {mounted && user ? (
              <>
                <Link href="/dashboard" onClick={() => setIsMobileMenuOpen(false)} className="w-full text-center hover:bg-[#0f172a] transition-colors text-base font-medium text-white tracking-tight font-dm-sans bg-[#1e293b] rounded-md py-3 px-5 shadow-sm">{t('nav.dashboard')}</Link>
