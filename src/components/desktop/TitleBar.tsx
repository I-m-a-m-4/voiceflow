    ...
    >
      <div className="flex items-center gap-2.5 px-4" data-tauri-drag-region>
         ...
         <div className="h-6 w-6 relative">
            ...
            <CachedImage src={displayLogo} alt="Voiceflow" className="h-6 w-6 relative z-10 drop-shadow-sm" />
         </div>
         <div className="flex flex-col" data-tauri-drag-region>
            <span className="text-[10px] font-black tracking-[0.25em] text-primary/90 leading-none">VOICEFLOW</span>
