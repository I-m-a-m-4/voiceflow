 ...
 *
 * n8n ships a dark-native palette. Voiceflow's marketing surface is light, and this
 ...
 *
 * The rest of the site runs on `hsl(var(--primary))`, which is Voiceflow's orange —
