...
const values = [
  {
    ...
    description: "Voiceflowns are incredibly hard-working and supportive people who want to see you succeed beyond your team.",
    icon: Users,
  ...
  },
  {
    ...
    description: "There's an enabling environment for you to explore your creativity and explore other skills at Voiceflow.",
    icon: TrendingUp,
    bgColor: "bg-blue-100",
...
const jobs = [
  {
    ...
    location: "Lagos",
    type: "Full-time",
    description: "Drive Voiceflow's global marketing strategy and lead our growth initiatives."
  },
  {
    id: "ambassador",
    ...
    location: "Global",
    type: "Contract",
    description: "Represent Voiceflow in your local market and build vibrant merchant communities."
  },
  {
    id: "sales-rep",
    ...
    location: "Nigeria",
    type: "Contract",
    description: "The boots on the ground helping retailers digitize their operations with Voiceflow."
  }
];
        ...
        <section className="relative flex items-center justify-center px-6 pt-48 pb-20 md:py-48 overflow-hidden bg-transparent">
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10">
            ...
            <p className="text-lg md:text-2xl text-slate-600 max-w-2xl mx-auto font-medium leading-relaxed font-dm-sans">
              Voiceflow is the operating system for a new era of commerce. Join our mission to empower millions of merchants across the continent.
            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[0.7fr_1.3fr] min-h-[500px]">
            ...
            <div className="flex flex-col justify-center p-8 md:p-12 lg:p-16 bg-white shrink-0">
              <div className="max-w-xl">
                ...
                <p className="text-slate-500 font-dm-sans mb-8 text-base">Because the smartest and most talented people in tech are building the future at Voiceflow.</p>
            ...
            <div className="relative overflow-hidden bg-slate-950 min-h-[400px] lg:min-h-full">
              <AnimatePresence>
                ...
                >
                  <img 
                    ...
                    alt={`Voiceflow HQ ${currentHqImage + 1}`} 
              ...
              <div className="absolute bottom-12 left-12 z-20">
                <h3 className="text-white text-3xl font-bold font-dm-sans mb-2 tracking-tight">The Voiceflow Campus</h3>
        ...
        <section id="openings" className="py-24 px-6 bg-white">
          <div className="max-w-5xl mx-auto bg-slate-50 rounded-[2rem] p-8 md:p-16">
            ...
            <div className="mt-16 text-center">
              ...
              <a href="mailto:careers@voiceflow.space" className="text-emerald-600 font-bold flex items-center justify-center gap-2 hover:underline">
                careers@voiceflow.space <ArrowRight className="w-5 h-5" />
              </a>
            </div>
          </div>
        </section>
      ...
      <Dialog open={!!selectedJob} onOpenChange={(open) => !open && setSelectedJob(null)}>
        <DialogContent className="sm:max-w-[500px] rounded-xl p-0 overflow-hidden border-none shadow-2xl">
          <div className="bg-stone-950 p-6 text-white relative overflow-hidden">
            ...
            <DialogHeader className="relative z-10 text-left">
              ...
              <DialogDescription className="text-white/60 text-xs font-medium font-dm-sans mt-1">
                Tell us why you're the perfect fit for the Voiceflow team.
              </DialogDescription>
            </DialogHeader>
          </div>
          ...
          <form onSubmit={handleApply} className="p-6 space-y-4 bg-white font-dm-sans">
            ...
            <p className="text-center text-xs text-slate-400 font-medium">By submitting, you agree to Voiceflow's recruitment policy.</p>
          </form>
        </DialogContent>
      </Dialog>
