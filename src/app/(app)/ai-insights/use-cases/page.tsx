...
const USE_CASES: UseCase[] = [
  ...
  },
  {
    ...
    capabilities: [
      ...
      { label: 'Straight to the page', detail: 'Ask to open Reports, Inventory or Settings and you get a button that takes you there. Zen AI only ever links inside Voiceflow — never to an outside site.' },
    ],
    examples: [
    ...
    <div className="min-h-[calc(100vh-64px)] bg-muted/40 flex flex-col">
      ...
      <div className="max-w-3xl mx-auto w-full px-5 pb-20 flex flex-col gap-4">
        ...
        <p className="text-[11px] text-muted-foreground text-center leading-relaxed px-6 mt-2">
          Zen AI reads your live business data. Answers reflect what is in Voiceflow at the moment you
