...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (staticPost) {
    return {
      title: `${staticPost.title} | Voiceflow Blog`,
  ...
  return {
    title: 'Blog Post | Voiceflow',
    description: 'Read the latest from Voiceflow on retail operations, AI, and business growth.',
    alternates: {
      canonical: `/blog/${id}`
    },
    robots: {
        ...
        '@graph': [
          {
            ...
            author: { '@type': 'Organization', name: 'Voiceflow', url: siteUrl },
