...
export const metadata: Metadata = {
  ...
  description: 'Stay updated with the latest retail trends, inventory management tips, and success stories from the Voiceflow community. Expert advice for Nigerian businesses.',
  keywords: [
  ...
  openGraph: {
    title: 'Voiceflow Blog - Master Your Retail Business',
