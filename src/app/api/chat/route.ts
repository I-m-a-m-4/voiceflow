...
const INJECTION_PATTERNS = [
  ...
  // The old allow-list of "zen|voiceflow" 400'd "act as my sales analyst" — a
...
// ─────────────────────────────────────────────────────────────────────────────
const SYSTEM_PROMPT = `You are Zen AI, the business intelligence copilot built into Voiceflow POS.
...
- If asked who you are: "I'm Zen AI, your Voiceflow copilot."
...
3. **No deletions.** You have NO delete tools whatsoever. You CANNOT delete products, customers, users, user bases, receipts, or transactions. If asked to delete anything, refuse politely and inform the user that deletions must be performed manually by them through the Voiceflow app interface.
...
- **\`proposeCostPrices\`** when they give you figures: "coke 380, indomie 190",
  ...
  id — Voiceflow matches the names against the real catalogue itself and tells you which ones
