...
const CATEGORIES: {
...
}[] = [
  {
    ...
    description: 'What you need to run Voiceflow, setting up your shop, and importing an existing catalogue.',
...
const ARTICLES: Article[] = [
  // --- Getting started ---
  {
    ...
    q: 'What do I need to run Voiceflow?',
  ...
  },
  {
    id: 'offline-first',
    category: 'getting-started',
    q: 'Does Voiceflow really work with no internet?',
  ...
  },
  {
    ...
    a: 'Print it, export it, or send it. On desktop, Voiceflow prints through your operating system, so any receipt printer already installed there works — including thermal printers. You can also export a PDF or email the customer a digital copy.',
  ...
  },
  {
    id: 'zen-ai-privacy',
    category: 'ai-reports',
    q: 'Does Voiceflow store what I type into Zen AI?',
      ...
      <section className="relative flex items-center justify-center overflow-hidden bg-transparent px-6 pb-16 pt-28 md:py-32">
        ...
        <div className="relative z-10 mx-auto max-w-3xl text-center">
          ...
          <p className="text-lg text-muted-foreground md:text-xl">
            {ARTICLES.length} answers about running Voiceflow — searchable, and written against
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto max-w-2xl text-muted-foreground">
              ...
              Voiceflow works, and they are the reason the rest of it behaves predictably.
            </p>
          </div>
      ...
      <section className="border-t border-border/60 px-6 py-16 md:py-24">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            ...
            <Link
              href="mailto:hello@voiceflow.com"
              className="group flex flex-col items-center gap-3 rounded-2xl border border-border/60 bg-card p-6 transition-all hover:border-primary/40 hover:shadow-md"
            >
              <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-primary/10 text-primary">
