  ...
  const guides = [
    {
      ...
      description: "Learn how Voiceflow maintains 100% uptime even without internet.",
        ...
        <div className="space-y-8">
          <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100 mb-8">
            ...
            <p className="text-slate-600 mb-4">
              Voiceflow&apos;s POS environment is built on a &quot;Local-First&quot; architecture. This means your data doesn&apos;t just &quot;live in the cloud&quot;—it lives directly on your device&apos;s hardware, specialized for high-turnover retail environments in Nigeria where internet stability can be unpredictable.
            </p>
          </div>
          ...
          <section className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="p-5 border border-slate-100 rounded-xl bg-white shadow-sm">
                ...
                <p className="text-sm text-slate-600">Voiceflow tracks &quot;Deltas&quot;—only the changes made—rather than re-uploading the entire inventory state, saving data and time.</p>
              </div>
              <div className="p-5 border border-slate-100 rounded-xl bg-white shadow-sm">
      ...
      content: (
        <div className="space-y-8">
          <p className="text-slate-600 text-lg">
            Protect your business by granting the right access to the right people. Voiceflow&apos;s RBAC (Role-Based Access Control) is designed for multi-staff retail operations.
          </p>
          ...
          <div className="p-6 bg-slate-900 text-white rounded-2xl relative overflow-hidden">
            ...
            <p className="text-slate-300 text-sm">Use 4-digit Quick PINs to switch between staff on a single terminal. Voiceflow logs every single transaction to a specific staff ID, ensuring 100% accountability for the cash drawer.</p>
          </div>
        </div>
      )
    },
        ...
        <div className="space-y-8">
          <div className="p-8 bg-black rounded-3xl text-white relative overflow-hidden">
            ...
            <p className="text-slate-400">
              Unlike traditional POS systems that just subtract sales from stock, Voiceflow&apos;s AI analyzes &quot;Shrinkage causality.&quot; It identifies exactly where your money is leaking—whether it&apos;s spoilage, theft, or administrative error.
            </p>
          </div>
          ...
          <section className="p-6 border border-slate-200 rounded-2xl">
            ...
            <p className="text-slate-600 mb-4">
              Retailers using Voiceflow&apos;s waste algorithm typically see a 22% reduction in spoilage within the first 60 days. The AI provides an &quot;Optimal Stock Calculation&quot;—telling you exactly how much to buy to avoid both stockouts and overstock waste.
            </p>
          </section>
        </div>
      )
    },
    {
      ...
      content: (
        <div className="space-y-8">
          <p className="text-slate-600 text-lg">
            Accelerate your checkout speed by 300% with hardware-accelerated barcode scanning. Voiceflow supports almost any standard scanner via USB or Bluetooth.
          </p>
          ...
          <div className="space-y-6">
            <div className="flex gap-4 p-5 bg-slate-50 rounded-xl border border-dashed border-slate-200">
              ...
              <div>
                ...
                <p className="text-sm text-slate-500">Most scanners work out of the box. Voiceflow listens for &quot;Rapid Fire&quot; keyboard events and instantly maps them to your SKU database.</p>
              </div>
            </div>
            <div className="flex gap-4 p-5 bg-slate-50 rounded-xl border border-dashed border-slate-200">
          ...
          <section className="space-y-4">
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-3 text-sm text-slate-700">
                ...
                <span>**Suffix/Prefix Stripping**: Voiceflow automatically removes common scanner suffixes like &apos;Enter&apos; or &apos;Tab&apos;.</span>
              </li>
              <li className="flex items-center gap-3 text-sm text-slate-700">
                <CheckCircle2 className="w-4 h-4 text-primary" />
    ...
    },
    {
      ...
      content: (
        <div className="space-y-8">
          <p className="text-slate-600 text-lg">
            Never lose a sale to an empty shelf again. Voiceflow&apos;s proactive alert system monitors your inventory 24/7.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-primary/5 rounded-2xl p-6 border border-primary/10">
              ...
              <p className="text-sm text-slate-600 leading-relaxed mb-4">
                Voiceflow doesn&apos;t just tell you it&apos;s low—it can generate a **Draft Purchase Order** automatically. 
              </p>
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="w-full flex flex-col items-center text-center gap-4 bg-primary pt-32 pb-20 px-6">
        <div className="flex flex-col items-center gap-3">
          ...
          <h1 className="text-3xl md:text-5xl font-bold text-white tracking-tight">Voiceflow Operations Manual</h1>
        </div>
        <p className="text-white/80 text-lg max-w-2xl mx-auto">
          Comprehensive guides and documentation for mastering the Voiceflow Ecosystem.
        </p>
               ...
               <div className="mt-20 pt-10 border-t border-slate-100">
                 <div className="bg-slate-50 p-8 rounded-2xl flex flex-col md:flex-row items-center justify-between gap-6">
                    <div>
                      ...
                      <p className="text-sm text-slate-500">Our team is available 24/7 to help you with your Voiceflow terminal.</p>
                    </div>
