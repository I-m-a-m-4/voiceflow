...
const siteUrl = 'https://voiceflow.space';
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: `${siteUrl}/voiceflow-og-image.png?v=5`,
        width: 1200,
        height: 630,
        type: 'image/png',
  ...
  twitter: {
    ...
    title: 'Voiceflow - Global Retail OS & POS Platform',
    description: 'Transform your retail operations with Voiceflow. Inventory, analytics, and global payments in one unified platform.',
    images: [`${siteUrl}/voiceflow-og-image.png?v=5`],
    creator: '@voiceflow_retail',
  }
};
...
const jsonLd = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      name: 'Voiceflow',
      url: siteUrl,
      logo: `${siteUrl}/voiceflow-og-image.png?v=5`,
      ...
      sameAs: [
        'https://x.com/voiceflow_retail',
        'https://www.instagram.com/voiceflow_pos/',
        'https://www.tiktok.com/@voiceflow_retail',
        'https://www.youtube.com/@VoiceflowPos'
      ]
    },
    {
