      ...
      <section className="relative overflow-hidden px-6 pb-12 pt-24 md:pb-16 md:pt-32">
        ...
        <div className="relative mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-[640px] text-lg leading-[26px] tracking-[-0.4px] text-slate-500 dark:text-slate-400">
            The rules and guidelines for using the Voiceflow Retail OS platform.
          </p>
        ...
        <div className="grid gap-10 lg:grid-cols-[260px_minmax(0,1fr)] lg:gap-14">
          ...
          <div className="min-w-0 prose prose-slate dark:prose-invert max-w-none lg:prose-lg prose-headings:scroll-mt-28">
            <div id="acceptance" className="scroll-mt-32">
              ...
              <p>
                By accessing or using the Voiceflow software-as-a-service platform (the "Service"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you may not use the Service. These Terms apply to all users of the Service, including administrators, managers, and operators ("Users").
              </p>
              ...
              <div className="not-prose my-8 p-5 rounded-2xl border bg-slate-50/50 dark:bg-slate-900/40 border-slate-200/60 dark:border-slate-800/60 flex flex-col sm:flex-row sm:items-center justify-between gap-4 text-sm backdrop-blur-sm shadow-sm">
                <div className="flex items-center gap-3 font-medium text-slate-800 dark:text-slate-200">
                  ...
                  <div>
                    Voiceflow Retail OS is operated by <strong className="text-primary">VOICEFLOWTECH SOLUTIONS</strong>
            ...
            <div id="description" className="scroll-mt-28 mt-16 pt-8 border-t border-slate-100 dark:border-slate-800/50">
              ...
              <p>
                Voiceflow provides a comprehensive business management platform that includes inventory management, a Point of Sale (POS) system, customer relationship management (CRM), sales analytics, and an optional public-facing e-commerce storefront.
              </p>
              <p>
            ...
            <div id="intellectual" className="scroll-mt-28 mt-16 pt-8 border-t border-slate-100 dark:border-slate-800/50">
              ...
              <p>
                The Service and its original content (excluding Your Content), features, and functionality are and will remain the exclusive property of Voiceflow and its licensors. The Service is protected by copyright, trademark, and other laws of both Nigeria and foreign countries.
              </p>
            </div>
