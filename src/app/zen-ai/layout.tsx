...
export const metadata: Metadata = {
  title: 'Zen AI | Ask Your Shop Anything — Built Into Voiceflow',
  description:
    'Zen AI is the assistant inside Voiceflow. Ask about stock, sales, customers and cash in plain words. It reads your live data, proposes changes as cards, and writes nothing until you approve.',
  ...
  openGraph: {
    ...
    url: 'https://voiceflow.space/zen-ai',
    type: 'website',
  },
  twitter: {
