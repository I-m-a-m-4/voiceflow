 ...
 *
 *   - `primary` is Voiceflow orange, not the spec's #ea0000 red. This page sits
...
const CAPABILITIES: {
  ...
  },
  {
    ...
    points: [
      ...
      'Ask for Reports or Inventory and get a button — only ever inside Voiceflow',
    ],
  },
  {
    icon: Gauge,
...
const FAQS: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: 'No. Zen AI is included in every Voiceflow plan. Plans differ only in how many questions a day they carry, and you can top up with bonus credits if you run out on a busy day.',
  },
  {
    ...
    <section className="py-20" style={{ background: 'var(--zia-canvas)' }}>
      <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          ...
          <p className="zia-body-md zia-measure mt-6" style={{ color: 'var(--zia-ink-soft)' }}>
            Zen AI comes with every Voiceflow plan. Plans differ only in how many
    ...
    >
      ...
      <div className="relative mx-auto flex max-w-[1200px] flex-col items-center px-4 text-center sm:px-6 lg:px-8">
        ...
        <p className="zia-body-lg zia-measure mt-6" style={{ color: 'rgba(255,255,255,.8)' }}>
          Zen AI is waiting inside Voiceflow on desktop, Android and iOS. Nothing
          to set up, and nothing it can change without you.
        </p>
        <div className="mt-12 flex flex-col items-center gap-4 sm:flex-row">
          <Cta href="/signup">Start free</Cta>
          <Ghost href="/download">Download Voiceflow</Ghost>
        </div>
      </div>
    </section>
  );
