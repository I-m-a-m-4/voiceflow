...
export const metadata: Metadata = {
  title: 'Sign Up | Start Free with Voiceflow',
  description: 'Join thousands of businesses using Voiceflow. Create your account and start managing your inventory and sales with our forever-free Starter plan.',
