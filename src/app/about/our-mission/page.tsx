 ...
 *   3  Why we built Voiceflow ... canvas    (new)
...
/** Section 3. The left column is the shop today; the right is the shop on Voiceflow. */
const FROM_TO: { from: string; to: string }[] = [
  {
    from: 'A screenshot of a bank alert that never cleared.',
    to: 'Voiceflow Terminal confirms the transfer against the bank and announces it at the counter, before the goods leave the shop.',
  },
  {
...
const PILLARS: { icon: React.ElementType; title: string; body: string }[] = [
  ...
  },
  {
    ...
    body: "Market conditions aren't perfect. Your POS should be. Voiceflow works 100% offline and syncs when back online.",
  },
  {
    icon: Lock,
    title: 'Anti-Theft Terminal',
    body: 'Eliminate staff cash-pocketing and fake bank alerts. Voiceflow Terminal confirms customer transfers instantly and alerts cashiers on-site.',
  },
];
...
const TESTIMONIALS: { quote: string; initials: string; name: string; role: string }[] = [
  {
    quote:
      'Voiceflow stopped being just a POS and started being a partner. It told me exactly which luxury silks to stop ordering and where I was losing money on belts.',
    initials: 'AB',
  ...
  {
    quote:
      'I used to spend 4 hours a night reconcilling numbers. Now, Voiceflow does it in real-time. My business is finally operating with clarity.',
    initials: 'CO',
    name: 'Chisom Okafor',
      ...
      <section className="relative overflow-hidden px-6 pb-24 pt-40 sm:pt-44 bg-[#F9F8F6]">
        ...
        <div className="relative z-10 mx-auto max-w-[1100px] text-center">
          ...
          >
            ...
            stores. Voiceflow unifies your operations into a single, proactive AI
            intelligence layer.
          </motion.p>
      ...
      <section className="border-t px-6 py-[140px]" style={{ borderColor: 'var(--av-hairline)' }}>
        <div className="mx-auto max-w-[1100px]">
          <Reveal className="max-w-2xl">
            ...
            <h2 className="av-display-lg mt-4">Why we built Voiceflow</h2>
           ...
           * labelled — "Today" above "On Voiceflow" is the only thing keeping the
          ...
          <div className="grid gap-16 lg:grid-cols-2 lg:items-start">
            ...
            <Reveal>
              ...
              <p className="av-body-lg av-measure mt-6" style={{ color: 'var(--av-ink-soft)' }}>
                ...
                none of it turns into usable judgment. Voiceflow changes that
                balance.
              </p>
        ...
        <div className="mx-auto max-w-[1100px]">
          <Reveal className="max-w-2xl">
            ...
            <p className="av-body-lg mt-6" style={{ color: 'var(--av-ink-soft)' }}>
              ...
              Voiceflow the same day they start.
            </p>
          </Reveal>
          ...
          <div className="grid gap-16 lg:grid-cols-2 lg:items-start">
            <Reveal>
              ...
              <p className="av-body-lg av-measure mt-6" style={{ color: 'var(--av-ink-soft)' }}>
                ...
                going wrong, and we will tell you honestly whether Voiceflow
                already handles it.
              </p>
        ...
        <Reveal>
          <div className="mx-auto max-w-[1100px] text-center">
            ...
            <p className="av-body-lg av-measure mx-auto mt-6" style={{ color: 'var(--av-ink-soft)' }}>
              ...
              management today with Voiceflow.
            </p>
