...
export const metadata: Metadata = {
  ...
  description: 'Learn why we built Voiceflow. Our mission is to provide retailers with the intelligence they need to thrive, minimize waste, and maximize profit with cutting-edge technology.',
  alternates: {
    canonical: '/about/our-mission'
  },
  openGraph: {
    title: 'The Voiceflow Mission - Beyond Just Software',
