...
const withPWA = withPWAInit({
  dest: "public",
  disable: Boolean(isTauri) || process.env.NODE_ENV === "development",
  register: true,
  workboxOptions: {
    importScripts: [
