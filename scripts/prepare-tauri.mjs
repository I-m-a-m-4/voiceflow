...
const WEB_ONLY = 'This action is only available in the web admin panel at voiceflow.space.';
 ...
 */
const PUSH_WEB_ONLY =
  'Phone push needs the web admin panel at voiceflow.space. The in-app alert was still delivered.';
